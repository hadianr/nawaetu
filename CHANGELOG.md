...
### Performance
- **Perf(home): defer below-fold widgets**

### Fixed
- **Fix(observability): capture early client errors**
- **Fix(analytics): preserve early activity events**
...
### Added
- **Feat(audio): add close button functionality to AudioPlayerBar**

### Improved
- **Style(nav): adjust bottom padding for better layout on mobile**

### Fixed
- **Fix(notification): improve error handling in toggleNotifications function**
...
### Added
- **Feat(pattern): use themed SVG overlays**
- **Feat(theme): add glass surface system**

### Fixed
- **Fix(home): compact quick access row**
- **Fix(layout): align mobile navigation**
- **Fix(notifications): handle foreground FCM**
- **Fix(notifications): preserve subscription errors**
- **Fix(release): dispatch publication after merge (#168)**
...
### Fixed
- **Fix(pwa): correct import path for Firebase messaging in service worker**
...
### Fixed
- **Fix(mentor-ai): enforce scoped AI responses**


## [1.12.16] - 2026-08-26

### Fixed
- **Fix(auth): align guest sync streak payload with StreakData schema**
- **Fix(habits): safely normalize streak data and handle undefined milestones**
...
### Improved
- **Refactor(share): unify story sharing and add canvas auto-fit**


## [1.12.11] - 2026-08-11

### Improved
- **Refactor(ponytail): fix getMany bug, cleanup unused storage abstractions & drop deprecated DB columns**

### Fixed
- **Fix: validation fcm not sent**


## [1.12.10] - 2026-08-10

### Fixed
- **Fix(cache): bump TUNE_VERSION to v5 to invalidate stale prayer cache**


## [1.12.9] - 2026-08-10

### Fixed
- **Fix(notif): remove double Maghrib ikhtiyath correction**
...
### Improved
- **Refactor(logs):  create standarize logger json for observability**
...
### Fixed
- **Fix: initialiaze firebase admin for push notif issue cron**


## [1.12.1] - 2026-07-27

### Added
- **Feat(prayer): replace Dhuhr with Jumu'ah for males on Friday**

### Fixed
- **Fix(notifications): enhance cross-platform FCM push and global prayer calculation**
