-- ============================================================================
-- Migration: 0000_create_core_tables.sql
-- Date Created: 2026-02-06
-- Description: Initial schema setup for Nawaetu app
-- Tables Created:
--   - account       (NextAuth SSO integrations)
--   - bookmark      (Quran bookmarks per user)
--   - push_subscription (FCM tokens & notification preferences)
