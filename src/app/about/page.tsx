            ...
            <div className="w-full max-w-none space-y-8 xl:max-w-4xl">
                ...
                <section className="bg-[rgb(var(--color-surface))]/70 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-[rgb(var(--color-border))]">
                    ...
                    <div className="space-y-4 text-[rgb(var(--color-text-muted))] leading-relaxed">
                        <p>
                            <strong className="text-[rgb(var(--color-text-strong))]">Nawaetu</strong> adalah aplikasi Muslim lengkap yang dirancang untuk membantu umat Islam membangun dan menjaga konsistensi ibadah sehari-hari. Dengan tagline <strong className="text-[rgb(var(--color-primary))]">#NiatAjaDulu</strong>, kami percaya bahwa setiap perjalanan ibadah dimulai dari niat yang tulus.
                        </p>
                        <p>
                ...
                <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {/* Al Quran */}
                        <Link href="/quran" className="group bg-[rgb(var(--color-surface))]/70 backdrop-blur-sm rounded-xl p-6 border border-[rgb(var(--color-border))] hover:border-[rgb(var(--color-primary))]/50 transition-all hover:scale-[1.02]">
                        ...
                        {/* Kiblat */}
                        <Link href="/qibla" className="group bg-[rgb(var(--color-surface))]/70 backdrop-blur-sm rounded-xl p-6 border border-[rgb(var(--color-border))] hover:border-[rgb(var(--color-primary))]/50 transition-all hover:scale-[1.02]">
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-[rgb(var(--color-primary))]/20 rounded-lg">
                        ...
                        {/* Daily Missions */}
                        <Link href="/missions" className="group bg-[rgb(var(--color-surface))]/70 backdrop-blur-sm rounded-xl p-6 border border-[rgb(var(--color-border))] hover:border-[rgb(var(--color-primary))]/50 transition-all hover:scale-[1.02]">
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-[rgb(var(--color-primary))]/20 rounded-lg">
                        ...
                        {/* AI Assistant */}
                        <Link href="/mentor-ai" className="group bg-[rgb(var(--color-surface))]/70 backdrop-blur-sm rounded-xl p-6 border border-[rgb(var(--color-border))] hover:border-[rgb(var(--color-primary))]/50 transition-all hover:scale-[1.02]">
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-[rgb(var(--color-primary))]/20 rounded-lg">
