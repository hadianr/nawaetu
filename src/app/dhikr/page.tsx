...
export default function DhikrPage() {
    return (
        <div className="dhikr-page fixed inset-0 flex h-[100dvh] w-full max-w-full flex-col items-center overflow-hidden bg-[rgb(var(--color-background))] bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(var(--color-primary),0.15),rgba(255,255,255,0))] font-sans text-[rgb(var(--color-text))]">
