            ...
            <div className="w-full max-w-none space-y-8 mb-12 xl:max-w-4xl">
                ...
                <div className="bg-[rgb(var(--color-surface))]/70 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-[rgb(var(--color-border))] space-y-6 text-[rgb(var(--color-text-muted))] leading-relaxed font-light">
                    <section className="space-y-3">
                        <h2 className="text-2xl font-bold text-[rgb(var(--color-text-strong))] mb-2">1. Agreement to Terms</h2>
                        <p>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-bold text-[rgb(var(--color-text-strong))] mb-2">2. Description of Service</h2>
                        <p>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-bold text-[rgb(var(--color-text-strong))] mb-2">3. User Accounts</h2>
                        <p>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-bold text-[rgb(var(--color-text-strong))] mb-2">4. Appropriate Use and Content</h2>
                        <p>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-bold text-[rgb(var(--color-text-strong))] mb-2">5. Open Source and Commercial License</h2>
                        <p>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-bold text-[rgb(var(--color-text-strong))] mb-2">6. Limitation of Liability</h2>
                        <p>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-bold text-[rgb(var(--color-text-strong))] mb-2">7. Contact Us</h2>
                        <p>
