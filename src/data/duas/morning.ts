...
export const MORNING_DUAS: DuaItem[] = [
    ...
    },
    {
        ...
        titleEn: "Du'a for Lawful Provision",
        ...
        virtue: "Doa kemandirian finansial yang autentik. Sangat relevan bagi anak muda yang sedang merintis karier dan berusaha menjaga integritas.",
        virtueEn: "An authentic prayer for financial independence. Highly relevant for young people building their careers while preserving integrity.",
        recommendedCount: 1,
        source: {
            type: "hadith",
    ...
    },
    {
        ...
        occasion: "morning",
        category: "spiritualCategoryIlmu",
        title: "Doa Sebelum Belajar / Bekerja",
        titleEn: "Du'a Before Studying or Working",
        ...
        virtue: "Doa Nabi Musa AS sebelum berdakwah kepada Fir'aun. Sangat cocok dibaca sebelum presentasi, ujian, atau memulai pekerjaan penting.",
        virtueEn: "Dua of Prophet Musa (AS) before speaking to Pharaoh. Perfect before presentations, exams, or starting important work.",
        recommendedCount: 1,
        source: {
            type: "quran",
