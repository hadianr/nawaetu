...
export const SETTINGS_TRANSLATIONS = {
  id: {
    ...
    aboutUpdate2: "Rate Limit cerdas (Free 5x/hari, Muhsinin 25x/hari)",
    aboutUpdate3: "Update Respon AI (Lebih ringkas & tanpa basa-basi)",
    aboutUpdate4: "Perbaikan UI Navigasi & Dark Mode",
    aboutUpdate5: "Optimasi performa & perbaikan bug",
