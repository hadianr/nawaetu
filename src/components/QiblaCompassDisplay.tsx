            ...
            <div className="relative flex items-center justify-center w-[85vw] h-[85vw] max-w-[320px] max-h-[320px] md:max-w-[360px] md:max-h-[360px]">
                ...
                {aligned && (
                    <>
                        ...
                        <div className={cn(
                            ...
                            "border-[rgb(var(--color-primary))]/20"
                ...
                >
                    ...
                    <div className={cn(
                        ...
                        aligned
                            ? "bg-[rgb(var(--color-primary))]/10 border-[rgb(var(--color-primary))] shadow-[var(--shadow-floating)]"
                        ...
                        <div
                            ...
                            style={{
                                background: `repeating-conic-gradient(from 0deg, rgba(var(--color-border),0.5) 0deg 0.5deg, transparent 0.5deg 5deg)`,
                    ...
                    >
                        <div className="absolute top-8 left-1/2 -translate-x-1/2">
                            ...
                            <div className={cn(
                                ...
                                !aligned && "bg-[rgb(var(--color-surface-subtle))] rounded-full p-2 border border-[rgb(var(--color-border))]"
                            )}>
                                ...
                                <KaabaIcon className={cn(
                                    ...
                                    aligned
                                        ? "opacity-100 brightness-110 text-[rgb(var(--color-primary-light))]"
                                        : "opacity-70 text-[rgb(var(--color-text-muted))]"
                                )} />
                            </div>
                        </div>
                    </div>
                ...
                <div className={cn(
                    ...
                    aligned
                        ? "bg-[rgb(var(--color-primary))]/40 border-[rgb(var(--color-primary))] shadow-[var(--shadow-card)] scale-125"
                        : "bg-[rgb(var(--color-surface-subtle))] border-[rgb(var(--color-border))] scale-100"
                )}>
                    <div className={cn(
                        "w-2 h-2 rounded-full transition-all duration-500",
                        aligned
                            ? "bg-[rgb(var(--color-primary-light))] animate-pulse"
                ...
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-20">
                    <div className={cn(
                        ...
                        aligned
                            ? "bg-[rgb(var(--color-primary-light))] h-6 animate-pulse"
                            : "bg-[rgb(var(--color-text-muted))] h-3"
                    )} />
                </div>
            </div>
            ...
            <div className="mt-10 text-center space-y-3 z-30">
                ...
                <div className={`transition-all duration-500 transform ${aligned ? 'scale-105' : 'scale-100'}`}>
                    <h2 className={cn(
                        ...
                        <span className="inline-flex items-center gap-2">{aligned && <AppIcon name="shield-check" size="sm" tone="success" />}{aligned ? t.qiblaAligned : t.qiblaFinding}</span>
                    </h2>
                </div>
                ...
                {aligned && (
                    <div className={cn(
                        ...
                        "bg-[rgb(var(--color-primary))]/20 border-[rgb(var(--color-primary))]/40 shadow-[var(--shadow-card)]"
                    )}>
                        <div className={cn(
                            "w-2 h-2 rounded-full animate-pulse shadow-[0_0_8px_rgb(var(--color-primary)/0.7)]",
                ...
                <div className={cn(
                    ...
                    "bg-[rgb(var(--color-surface-subtle))] border-[rgb(var(--color-border))] text-[rgb(var(--color-text-muted))] shadow-[var(--shadow-card)]"
                )}>
                    <div className="space-y-1">
                        ...
                        <div>
                            <span className="text-[rgb(var(--color-text-muted))]">{t.qiblaDalilQuranRef}: </span>
