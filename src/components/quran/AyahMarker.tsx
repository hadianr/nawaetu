    ...
    return (
        <span className="relative inline-flex items-center justify-center w-10 h-10 ms-1 select-none">
            <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full text-emerald-500">
                ...
                <circle cx="20" cy="20" r="14" className="fill-emerald-950/20" />
            </svg>

            {/* Arabic Number Centered */}
            <span className="absolute text-sm font-bold text-emerald-100 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pt-[2px]">
                {number}
            </span>
        </span>
    );
