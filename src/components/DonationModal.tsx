            ...
            <DialogContent className={cn(
                ...
                <div className={cn(
                    ...
                    <div className={cn(
                        ...
                        "bg-gradient-to-t from-[rgb(var(--color-surface))] to-transparent"
                    )}></div>
                    ...
                    <div className="relative z-20 flex flex-col items-center animate-in zoom-in duration-500">
                        <div className={cn(
                            ...
                            <Heart className="w-8 h-8 text-[rgb(var(--color-primary-foreground))] fill-[rgb(var(--color-primary-foreground))]" />
                        </div>
                    </div>
                </div>
                        ...
                        <div className="space-y-4">
                            <div className={cn(
                                ...
                                <p className={cn(
                                    ...
                                    "text-[rgb(var(--color-accent-foreground))]/80"
                                )}>
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            !isCustomMode && selectedAmount === option.value
                                                ? "bg-[rgb(var(--color-primary))]/10 border-[rgb(var(--color-primary))] shadow-[var(--shadow-card)]"
                            ...
                            {isCustomMode && (
                                <div className="space-y-2 animate-in slide-in-from-top-2 duration-300">
                                    <div className="relative">
                                        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[rgb(var(--color-text-muted))] font-bold">Rp</span>
                                        <input
                                            type="number"
                                            ...
                                            className={cn(
                                                ...
                                                "bg-[rgb(var(--color-surface-subtle))]/60 border-[rgb(var(--color-border))]/20 text-[rgb(var(--color-text-strong))] placeholder:text-[rgb(var(--color-text-muted))] focus:border-[rgb(var(--color-ring))] focus:ring-[rgb(var(--color-ring))]"
                                            )}
                                            autoFocus
                                        />
                                    </div>
                                    <p className="text-[10px] text-[rgb(var(--color-text-muted))] px-1 italic">Minimal Rp 5.000 (Ketentuan Payment Gateway)</p>
                                </div>
                            )}
