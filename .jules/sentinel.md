...
**Resolution (2026-02-19):** Removed the `/api/debug/user-data` endpoint and its tests entirely as it was redundant and posed a high security risk by exposing PII.
